...
const nextConfig = {
  ...
  async headers() {
    ...
    const connectSrc = isDev
      ? "connect-src 'self' http://localhost:5000 http://127.0.0.1:5000 https://www.google-analytics.com https://vitals.vercel-analytics.com https://deal-aggregator-api-production.up.railway.app"
