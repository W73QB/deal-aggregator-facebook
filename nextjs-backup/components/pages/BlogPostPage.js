          ...
          <header className="post-header">
            ...
            {post.image && (
              <div className="post-image">
                <OptimizedImage src={post.image} alt={post.title} width={800} height={450} />
              </div>
            )}
          </header>
            ...
            <div className="related-posts-grid">
              {relatedPosts.map((relatedPost) => (
                <article key={relatedPost.id} className="related-post-card">
                  <Link href={`/blog/${relatedPost.slug}`} className="related-post-link">
                    {relatedPost.image && (
                      <div className="related-post-image">
                        <OptimizedImage src={relatedPost.image} alt={relatedPost.title} width={400} height={225} />
                      </div>
                    )}
