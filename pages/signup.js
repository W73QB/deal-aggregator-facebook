...
export default function Signup() {
  ...
  const { signup, isAuthenticated, isLoading, error, loginAttempting, clearError } = useAuth();
  ...
  return (
    <>
      <Head>
        <title>Sign Up - DealRadarUS</title>
        <meta name="description" content="Create your DealRadarUS account to access personalized deals, save favorites, and get exclusive offers." />
        ...
        <div className="auth-container">
          <div className="auth-card">
            <div className="auth-header">
              ...
              <p>Join DealRadarUS to discover exclusive deals</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="auth-form">
              ...
              <div className="form-group checkbox-group">
                <label htmlFor="newsletter_subscribed" className="checkbox-label">
                  <input
                    type="checkbox"
                  ...
                  <span>Subscribe to newsletter for exclusive deals and updates</span>
                </label>
              </div>
