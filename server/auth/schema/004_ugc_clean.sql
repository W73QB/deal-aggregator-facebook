...
DROP TABLE IF EXISTS public.deal_stats CASCADE;
DROP TYPE IF EXISTS report_status CASCADE;
DROP TYPE IF EXISTS content_type CASCADE;
DROP FUNCTION IF EXISTS calculate_avg_rating(TEXT) CASCADE;
DROP FUNCTION IF EXISTS update_deal_rating_stats() CASCADE;
DROP FUNCTION IF EXISTS update_deal_comment_stats() CASCADE;
...
CREATE TABLE public.deal_stats (
